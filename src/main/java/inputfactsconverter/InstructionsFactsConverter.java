 ...
 * @author anantoni
 */
public class InstructionsFactsConverter implements FactsConverter {
    ...
    private List<InstructionIndex> instructionIndexFactsList = null;
...
//            System.out.println( "Instruction-Index facts converted: " + instructionIndexFactsList.size() );
    ...
    public List<InstructionRef> getInstructionRefFactsList() {
        return this.instructionRefFactsList;
    }

    public List<CallGraphEdgeSourceRef> getCallGraphEdgeSourceRefFactsList() {
