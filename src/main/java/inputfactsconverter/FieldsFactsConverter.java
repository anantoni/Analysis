 ...
 * @author anantoni
 */
public class FieldsFactsConverter implements FactsConverter, Runnable {
    private List<FieldSignatureRef> fieldSignatureRefFactsList = null;
    private List<MethodSignatureRef> methodSignatureRefFactsList = null;
    private List<Var> varRefFactsList = null;
    private List<LoadInstanceField> loadInstanceFieldFactsList = null;
    private List<LoadStaticField> loadStaticFieldFactsList = null;
    private List<LoadPrimStaticField> loadPrimStaticFieldFactsList = null;
    private List<StoreInstanceField> storeInstanceFieldFactsList = null;
    private List<StoreStaticField> storeStaticFieldFactsList = null;
    private List<StorePrimStaticField> storePrimStaticFieldFactsList = null;
    private FactsID id = null;
    private Thread t = null;
    
    public FieldsFactsConverter(FactsID id, List<Var> varRefFactsList, List<MethodSignatureRef> methodSignatureRefFactsList, List<FieldSignatureRef> fieldSignatureRefFactsList) {
        ...
        this.loadInstanceFieldFactsList = new ArrayList<>();
        this.loadStaticFieldFactsList = new ArrayList<>();
        this.loadPrimStaticFieldFactsList = new ArrayList<>();
        this.storeInstanceFieldFactsList = new ArrayList<>();
        this.storeStaticFieldFactsList  = new ArrayList<>();
        this.storePrimStaticFieldFactsList  = new ArrayList<>();
        this.id = id;
    }    
