 ...
 * anantoni
 */
public class VariableDeclarationsFactsConverter implements FactsConverter, Runnable {
    List<Type> typeFactsList = null;
    List<Var> varFactsList = null;
    List<MethodSignatureRef> methodSignatureRefFactsList = null;
    FactsID id = null;
    private Thread t = null;
    
    public VariableDeclarationsFactsConverter(FactsID id, List<Type> typeFactsList ) {
    ...
    public List<MethodSignatureRef> getMethodSignatureRefFactsList() {
        return this.methodSignatureRefFactsList;
    }
    
    public List<Var> getvarFactsList() {
