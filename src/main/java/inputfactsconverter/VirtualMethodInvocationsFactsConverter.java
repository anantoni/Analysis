 ...
 * @author anantoni
 */
public class VirtualMethodInvocationsFactsConverter implements FactsConverter, Runnable {
    ...
    private List<VirtualMethodInvocation> virtualMethodInvocationFactsList = null;
    private FactsID id = null;
    private Thread t = null;
    
    public VirtualMethodInvocationsFactsConverter(FactsID id, List<Var> varFactsList, List<MethodSignatureRef> methodSignatureRefFactsList, List<MethodInvocationRef> methodInvocationRefFactsList) {
