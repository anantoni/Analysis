 ...
 * @author anantoni
 */
public class SpecialMethodInvocationsFactsConverter implements FactsConverter, Runnable {
    ...
    private List<SpecialMethodInvocation> specialMethodInvocationFactsList = null;
    private FactsID id = null;
    private Thread t = null;
    
    public SpecialMethodInvocationsFactsConverter(FactsID id, List<Var> varFactsList, List<MethodSignatureRef> methodSignatureRefFactsList, List<MethodInvocationRef> methodInvocationRefFactsList) {
