 ...
 * @author anantoni
 */
public class LibraryFactsConverter implements FactsConverter, Runnable {
    FactsID id = null;
    private List<Type> typeFactsList = null;
    private List<MethodSignatureRef> methodSignatureRefFactsList = null;
    private List<InitializedClass> initializedClassFactsList = null;
    private List<ClassInitializer> classInitializerFactsList = null;
    private List<MainMethodDeclaration> mainMethodDeclarationFactsList = null;
    private List<ImplicitReachable> implicitReachabeFactsList = null;
    private List<AssignCompatible> assignCompatibleFactsList = null;
    private List<MethodLookup> methodLookupFactsList = null;
    ...
    private List<AssignNormalHeapAllocation> assignNormalHeapAllocationFactsList = null;
    private List<AssignAuxiliaryHeapAllocation> assignAuxiliaryHeapAllocationFactsList = null;
    private List<AssignContextInsensitiveHeapAllocation> assignContextInsensitiveHeapAllocationFactsList = null;
    Thread t = null;
    
    public LibraryFactsConverter( FactsID id, List<Type> typeFactsList, List<MethodSignatureRef> methodSignatureRefFactsList, 
                                    List<MethodDescriptorRef> methodDescriptorRefFactsList, List<SimpleNameRef> simplenNameRefFactsList,
                                    List<HeapAllocationRef> heapAllocationRefFactsList, List<Var> varFactsList ) {
        this.id = id;
