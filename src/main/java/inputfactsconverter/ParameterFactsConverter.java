 ...
 * @author anantoni
 */
public class ParameterFactsConverter implements FactsConverter {
    ...
    private List<FormalParam> formalParamFactsList = null;
    private List<ActualParam> actualParamFactsList = null;
    private List<ThisVar> thisVarFactsList = null;
    private List<InstructionRef> instructionRefFactsList = null;
    private List<CallGraphEdgeSourceRef> callGraphEdgeSourceRefFactsList = null;
    private FactsID id = null;
    
    public ParameterFactsConverter(FactsID id, List<Var> varFactsList, List<CallGraphEdgeSourceRef> callGraphEdgeSourceRefFactsList, List<MethodSignatureRef> methodSignatureRefFactsList) {
    ...
    public List<MethodInvocationRef> getMethodInvocationRefFactsList() {
