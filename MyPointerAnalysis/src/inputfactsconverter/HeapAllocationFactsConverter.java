 ...
 * anantoni
 */
public class HeapAllocationFactsConverter extends FactsConverter implements Runnable {
    ...
    ArrayList<CallGraphEdgeSourceRef> callGraphEdgeSourceRefFactsList = null;
    FactsID id = null;
    Thread t = null;
    
    public HeapAllocationFactsConverter( FactsID id, ArrayList<Type> typeFactsList, ArrayList<CallGraphEdgeSourceRef> callGraphEdgeSourceRefFactsList) {
        super();
    ...
    public ArrayList<HeapAllocationRef> getHeapAllocationRefFactsList() {
